...
- [review] **FND.TEST.3** — Execute Error Recovery e2e tests. Run the test plan from `tests/e2e/plans/error-recovery-phase1.md` via chrome-devtools MCP. Screenshot each test case. Record results to `tests/e2e/results/`. File bugs as `FX.*` tasks in TASKS.md for any failures.
