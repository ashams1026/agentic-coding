...
- [x] **CWF.TEST.2** — Execute Custom Workflows e2e tests. Run the test plan via chrome-devtools MCP. Screenshot each test case. Record results to `tests/e2e/results/`. File bugs as `FX.*` tasks for any failures. *(completed 2026-04-02 18:00 PDT)*
