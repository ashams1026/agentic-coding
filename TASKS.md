...
- [review] **TPL.1** — Backend: add `templates` table to schema (id, name, type work_item/persona, content JSON, isBuiltIn boolean, createdAt). Seed 3 built-in work item templates (Bug Report, Feature Request, Spike). Generate migration.
