...
- [x] **S26.TEST.2** — Write e2e test plan for Search: `tests/e2e/plans/search-phase1.md`. Cover: command palette search, work items filter bar search, result ranking, type filtering, empty results. *(completed 2026-04-03 00:30 PDT)*
