...
- [review] **O.13** — Update router. In `packages/frontend/src/router.tsx`: remove `/board`, `/stories/:id`, `/tasks/:id` routes. Add `/items` route pointing to new work items page. Remove workflow designer page import. Update dashboard links.
