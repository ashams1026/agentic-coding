...
- [review] **ANL.4** — Frontend: create `packages/frontend/src/pages/analytics.tsx` page. Add `/analytics` route in router.tsx. Add "Analytics" link with BarChart3 icon in sidebar between Activity Feed and Chat. Page has two tabs: "Overview" and "Token Usage".
