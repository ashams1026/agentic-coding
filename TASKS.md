...
- [review] **FND.TEST.4** — Execute Work Item Lifecycle e2e tests. Run the test plan from `tests/e2e/plans/work-item-lifecycle.md` via chrome-devtools MCP. Screenshot each test case. Record results to `tests/e2e/results/`. File bugs as `FX.*` tasks for any failures.
