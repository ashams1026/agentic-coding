...
- [review] **SCH.4** — Frontend: add Schedules UI in Persona Manager or Settings. Schedule list with name, persona, cron (human-readable), next run, status. Add/edit form with cron preset selector (every 30min, hourly, daily, custom) + live preview of next runs. Active/disabled toggle.
