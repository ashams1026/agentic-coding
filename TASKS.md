...
- [review] **T2.6.2** — Build history filters and aggregate stats. Filter by: persona, outcome (success/failure/rejected), date range, cost range. Stats bar above list: total runs, total cost, success rate %, average duration. Updates reactively as filters change.
